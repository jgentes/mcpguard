...
<Callout type="warning" title="Default: No Network">
  By default, MCPs have **zero network access**. All outbound requests are blocked unless explicitly allowed.
</Callout>
...
1. Ensure your IDE configuration files exist:
   ...
   - **Cursor**: `~/.cursor/User/globalStorage/mcp.json`
   - **GitHub Copilot**: `~/.github-copilot/apps.json`
